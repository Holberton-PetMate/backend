...
class UserController extends Controller
{
    ...
    public function redeem_feeder(Request $request, User $user, Feeder $feeder)
    {
        ...
        $feeder->name = $request->get("feeder_name");
        $feeder->active_food = $request->get("feeder_active_food");
        $feeder->save();
